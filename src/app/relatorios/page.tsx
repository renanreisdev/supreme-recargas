    ...
    <div className="space-y-6 print:space-y-4 print:p-0 print:m-0">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-[#0e1626] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm print:hidden">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Button onClick={handleExportFinancialCSV} variant="outline" size="sm" className="gap-1.5 text-xs font-semibold h-9 rounded-xl border-slate-200 dark:border-slate-700">
          ...
          <Button 
            ...
            size="sm" 
            className="bg-slate-900 hover:bg-slate-800 dark:bg-emerald-600 dark:hover:bg-emerald-700 text-white gap-1.5 text-xs font-bold h-9 rounded-xl shadow-md transition-all active:scale-95 px-4"
            title="Imprimir relatório em PDF ou papel A4"
          >
      ...
      <div className="bg-white dark:bg-[#0e1626] rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 space-y-3.5 print:hidden">
        {/* Quick Date Presets */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2.5 pt-2 border-t border-slate-100 dark:border-slate-800">
          <div>
          ...
          <div>
            ...
            <Select value={selectedPaymentMethod} onChange={e => setSelectedPaymentMethod(e.target.value)} className="text-xs h-9 rounded-xl">
          ...
          <div>
            ...
            <Select value={selectedPaymentStatus} onChange={e => setSelectedPaymentStatus(e.target.value)} className="text-xs h-9 rounded-xl">
      ...
      {activeTab === 'FINANCIAL' && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 print:grid-cols-4 print:gap-2 print:mb-3">
          <div className="bg-slate-900 dark:bg-[#0c1424] text-white p-5 rounded-2xl border border-slate-800 shadow-sm print:bg-white print:text-black print:border-2 print:border-slate-800 print:p-2.5 print:rounded-lg print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-slate-400 print:text-slate-700 font-bold uppercase tracking-wider">Total Liquidado (Caixa)</span>
              <CheckCircle className="w-4 h-4 text-emerald-400 print:hidden" />
            </div>
            <p className="text-2xl print:text-lg font-black text-emerald-400 print:text-emerald-800 mt-1.5 font-mono">{formatCurrency(totalReceived)}</p>
            <p className="text-[11px] text-slate-400 print:text-slate-600 mt-0.5 font-medium">{paidEntries.length} comandas pagas</p>
          </div>

          <div className="bg-slate-900 dark:bg-[#0c1424] text-white p-5 rounded-2xl border border-slate-800 shadow-sm print:bg-white print:text-black print:border-2 print:border-slate-800 print:p-2.5 print:rounded-lg print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-slate-400 print:text-slate-700 font-bold uppercase tracking-wider">A Receber (A Prazo)</span>
              <Clock className="w-4 h-4 text-amber-400 print:hidden" />
            </div>
            <p className="text-2xl print:text-lg font-black text-amber-400 print:text-amber-800 mt-1.5 font-mono">{formatCurrency(totalPending)}</p>
            <p className="text-[11px] text-slate-400 print:text-slate-600 mt-0.5 font-medium">{pendingEntries.length} comandas pendentes</p>
          </div>

          <div className="bg-slate-900 dark:bg-[#0c1424] text-white p-5 rounded-2xl border border-slate-800 shadow-sm print:bg-white print:text-black print:border-2 print:border-slate-800 print:p-2.5 print:rounded-lg print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-slate-400 print:text-slate-700 font-bold uppercase tracking-wider">Faturamento Gerado</span>
              <TrendingUp className="w-4 h-4 text-teal-400 print:hidden" />
            </div>
            <p className="text-2xl print:text-lg font-black text-teal-300 print:text-teal-800 mt-1.5 font-mono">{formatCurrency(totalNetRevenue)}</p>
            <p className="text-[11px] text-slate-400 print:text-slate-600 mt-0.5 font-medium">{filteredEntries.length} atendimentos</p>
          </div>

          <div className="bg-slate-900 dark:bg-[#0c1424] text-white p-5 rounded-2xl border border-slate-800 shadow-sm print:bg-white print:text-black print:border-2 print:border-slate-800 print:p-2.5 print:rounded-lg print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-slate-400 print:text-slate-700 font-bold uppercase tracking-wider">Descontos Concedidos</span>
              <DollarSign className="w-4 h-4 text-rose-400 print:hidden" />
            </div>
            <p className="text-2xl print:text-lg font-black text-rose-400 print:text-rose-800 mt-1.5 font-mono">{formatCurrency(totalDiscounts)}</p>
            <p className="text-[11px] text-slate-400 print:text-slate-600 mt-0.5 font-medium">Bruto: {formatCurrency(totalGrossRevenue)}</p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'FINANCIAL' && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 print:grid-cols-4 print:gap-2 print:mb-3">
          {/* PIX */}
          <div className="p-4 rounded-2xl bg-white dark:bg-[#0e1626] border border-slate-200 dark:border-slate-800 shadow-xs print:bg-white print:border print:border-slate-400 print:p-2 print:rounded print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-emerald-600 text-white text-[10px] print:bg-slate-100 print:text-black print:border print:border-slate-400 font-bold">{countPix} rec.</Badge>
            </div>
            <p className="text-xl print:text-sm font-black text-emerald-700 dark:text-emerald-400 print:text-slate-900 mt-2 print:mt-1 font-mono">{formatCurrency(totalPix)}</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-[#0e1626] border border-slate-200 dark:border-slate-800 shadow-xs print:bg-white print:border print:border-slate-400 print:p-2 print:rounded print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-amber-600 text-white text-[10px] print:bg-slate-100 print:text-black print:border print:border-slate-400 font-bold">{countCash} rec.</Badge>
            </div>
            <p className="text-xl print:text-sm font-black text-amber-800 dark:text-amber-300 print:text-slate-900 mt-2 print:mt-1 font-mono">{formatCurrency(totalCash)}</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-[#0e1626] border border-slate-200 dark:border-slate-800 shadow-xs print:bg-white print:border print:border-slate-400 print:p-2 print:rounded print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-blue-600 text-white text-[10px] print:bg-slate-100 print:text-black print:border print:border-slate-400 font-bold">{countCards} rec.</Badge>
            </div>
            <p className="text-xl print:text-sm font-black text-blue-800 dark:text-blue-300 print:text-slate-900 mt-2 print:mt-1 font-mono">{formatCurrency(totalCards)}</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-[#0e1626] border border-slate-200 dark:border-slate-800 shadow-xs print:bg-white print:border print:border-slate-400 print:p-2 print:rounded print:shadow-none print-avoid-break">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-purple-600 text-white text-[10px] print:bg-slate-100 print:text-black print:border print:border-slate-400 font-bold">{countAPrazo} pend.</Badge>
            </div>
            <p className="text-xl print:text-sm font-black text-purple-800 dark:text-purple-300 print:text-slate-900 mt-2 print:mt-1 font-mono">{formatCurrency(totalAPrazo)}</p>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 print:hidden">
        <button
          ...
          className={`pb-3 px-4 text-xs font-bold transition-all border-b-2 ${activeTab === 'FINANCIAL' ? 'border-emerald-600 text-emerald-700 dark:text-emerald-400 font-black' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
        >
          Extrato Financeiro & Baixas de Entrega ({filteredEntries.length})
        </button>
        <button
          onClick={() => setActiveTab('TECHNICAL')}
          className={`pb-3 px-4 text-xs font-bold transition-all border-b-2 ${activeTab === 'TECHNICAL' ? 'border-emerald-600 text-emerald-700 dark:text-emerald-400 font-black' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
        >
      ...
      {activeTab === 'FINANCIAL' && (
        <div className="bg-white dark:bg-[#0e1626] rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden print:border print:border-slate-400 print:shadow-none">
          <div className="p-4 border-b border-slate-200 dark:border-slate-800 print:py-2 print:border-slate-400">
            <h3 className="text-sm font-black text-slate-900 dark:text-slate-100 print:text-slate-950">
          ...
          <div className="overflow-x-auto print:overflow-visible">
            <table className="w-full text-left text-xs print:text-[11px]">
              <thead className="bg-slate-50 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400 print:bg-slate-200 print:text-black font-bold uppercase tracking-wider text-[10px] print:border-b-2 print:border-slate-400">
                <tr>
                  <th className="p-3.5 print:p-2">N° Comanda</th>
                  <th className="p-3.5 print:p-2">Data / Hora</th>
                  <th className="p-3.5 print:p-2">Cliente</th>
                  <th className="p-3.5 print:p-2">Forma Pagamento</th>
                  <th className="p-3.5 print:p-2">Status</th>
                  <th className="p-3.5 print:p-2">Valor Pago</th>
                  <th className="p-3.5 print:p-2">Quem Retirou</th>
                  <th className="p-3.5 text-right print:p-2">Atendente</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium print:divide-slate-300">
                {filteredEntries.map((e) => {
                  ...
                  return (
                    <tr key={e.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors print:hover:bg-transparent print-avoid-break">
                      <td className="p-3.5 print:p-2 font-mono font-black text-slate-900 dark:text-slate-100 print:text-black">
                        {e.entry_number}
                      </td>
                      <td className="p-3.5 print:p-2 text-slate-500 print:text-slate-800 font-mono text-[11px] print:text-[10px]">
                        {e.paid_at ? formatDateTime(e.paid_at) : formatDateTime(e.entry_date)}
                      </td>
                      <td className="p-3.5 print:p-2">
                        <div className="font-bold text-slate-900 dark:text-slate-100 print:text-black">{e.customer?.name}</div>
                      ...
                      <td className="p-3.5 print:p-2">
                        <Badge className={`${paymentBadge.className} print:bg-slate-100 print:text-black print:border print:border-slate-400`}>
                          {e.payment_status === 'PAGO' ? '✓ Liquidado' : 'Pendente'}
                        </Badge>
                      </td>
                      <td className="p-3.5 print:p-2 font-black text-emerald-700 dark:text-emerald-400 print:text-black font-mono">
                      ...
                      <td className="p-3.5 print:p-2 text-right font-mono text-[11px] print:text-[10px] text-slate-600 dark:text-slate-300 print:text-black">
        ...
        <div className="bg-white dark:bg-[#0e1626] rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden print:border print:border-slate-400 print:shadow-none">
          ...
          <div className="overflow-x-auto print:overflow-visible">
            <table className="w-full text-left text-xs print:text-[11px]">
              <thead className="bg-slate-50 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400 print:bg-slate-200 print:text-black font-bold uppercase tracking-wider text-[10px] print:border-b-2 print:border-slate-400">
                <tr>
                  <th className="p-3.5 print:p-2">Serial</th>
                  <th className="p-3.5 print:p-2">Modelo</th>
                  <th className="p-3.5 print:p-2">Série Final</th>
                  <th className="p-3.5 print:p-2">Peso Entrada</th>
                  <th className="p-3.5 print:p-2">Peso Saída</th>
                  <th className="p-3.5 print:p-2">Delta Tinta</th>
                  <th className="p-3.5 print:p-2">Diagnóstico</th>
                  <th className="p-3.5 text-right print:p-2">Técnico</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium print:divide-slate-300">
                {filteredCartridges.map((c) => {
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors print:hover:bg-transparent print-avoid-break">
                      <td className="p-3.5 print:p-2 font-mono font-black text-slate-900 dark:text-slate-100 print:text-black">
                        {c.serial_number}
                      </td>
                      <td className="p-3.5 print:p-2 font-bold text-slate-900 dark:text-slate-100 print:text-black">
                        {c.model?.brand_name} {c.model?.model_name} ({c.color})
                      </td>
                      <td className="p-3.5 print:p-2 font-mono font-black text-amber-700 dark:text-amber-400 print:text-black">
                        {c.final_serie}
                      </td>
                      <td className="p-3.5 print:p-2 text-slate-600 dark:text-slate-400 print:text-black font-mono">
                        {c.input_weight_grams ? `${c.input_weight_grams}g` : '-'}
                      </td>
                      <td className="p-3.5 print:p-2 text-slate-600 dark:text-slate-400 print:text-black font-mono">
                        {c.output_weight_grams ? `${c.output_weight_grams}g` : '-'}
                      </td>
                      <td className="p-3.5 print:p-2 font-mono font-black text-emerald-600 dark:text-emerald-400 print:text-black">
                        {c.weight_diff_grams ? `+${c.weight_diff_grams}g` : '-'}
                      </td>
                      <td className="p-3.5 print:p-2">
                        <Badge className={`${resultBadge.className} print:bg-slate-100 print:text-black print:border print:border-slate-400`}>
                          {resultBadge.label}
                        </Badge>
                      </td>
                      <td className="p-3.5 print:p-2 text-right font-mono text-[11px] print:text-[10px] text-slate-600 dark:text-slate-400 print:text-black">
                        {c.technician?.full_name || 'Técnico'}
                      </td>
                    </tr>
                  );
                })}
